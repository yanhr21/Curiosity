...
- `heldout_cup_full_low_hidden` pass `False` regressions `accel_worse_than_best_baseline, lift_below_best_baseline_tolerance, hold_below_best_baseline_tolerance` improvements `slip_better_than_best_baseline`
- `heldout_cylinder_heavy_low_masked_vision` pass `False` regressions `candidate_not_success, accel_worse_than_best_baseline` improvements `slip_better_than_best_baseline`
