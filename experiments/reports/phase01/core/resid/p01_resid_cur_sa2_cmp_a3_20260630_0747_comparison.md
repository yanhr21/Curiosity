...
- `heldout_cup_empty_high_misleading` pass `False` regressions `accel_worse_than_best_baseline` improvements `none`
...
- `heldout_cylinder_heavy_low_masked_vision` pass `False` regressions `accel_worse_than_best_baseline` improvements `slip_better_than_best_baseline`
