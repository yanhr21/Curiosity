...
- [x] enforce a machine model/data admission boundary: 199 SUGAR trajectories are ready for the
  fixed two-task post-training audit only and forbidden for 5B foundation pre-training;
