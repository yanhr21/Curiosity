...
Code lives outside this repo, in a package that depends on Newton:
`/lustre/fs12/.../robot_baby/sugar_newton/`. Plan 16 §3 — `git diff` against upstream
Newton must stay empty.
