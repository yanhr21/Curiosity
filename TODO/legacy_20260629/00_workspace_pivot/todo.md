# Phase 00 TODO: Workspace Pivot

- [x] Move the old `idea.md` into `IDEA/`.
- [x] Create staged `PLAN/` and `TODO/` directories.
- [x] Move old roadmap and TODO into legacy subdirectories.
- [x] Archive pre-pivot experiment and log directories under root `legacy/`.
- [x] Update root README to point to the post-pivot structure.
