...
from .shared_budget_cop import SharedBudgetCoPController
...
class SharedBudgetCoPScene(SurfaceGripScene):
    def __init__(self, *args, **kwargs):
        if kwargs.get('controller_type') is not SharedBudgetCoPController:
