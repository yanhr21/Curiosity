...
from .coordinated_rotation_cop import CoordinatedRotationCoPController
...
class CoordinatedRotationCoPScene(SurfaceGripScene):
    def __init__(self, *args, **kwargs):
        if kwargs.get('controller_type') is not CoordinatedRotationCoPController:
