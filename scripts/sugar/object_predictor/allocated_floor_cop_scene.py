...
from .allocated_floor_cop import AllocatedFloorCoPController
...
class AllocatedFloorCoPScene(SurfaceGripScene):
    def __init__(self, *args, **kwargs):
        if kwargs.get('controller_type') is not AllocatedFloorCoPController:
