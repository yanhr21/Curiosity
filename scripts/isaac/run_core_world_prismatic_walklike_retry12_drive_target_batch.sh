...
env "${COMMON_ENV[@]}" \
  STAMP=20260705_prismatic_cradle_walklike_quasistep_target017_drive023_retry12a \
  MOTION_MODE=quasistatic_step_cycle \
  bash scripts/isaac/run_core_world_prismatic_carrier_stand.sh

env "${COMMON_ENV[@]}" \
  STAMP=20260705_prismatic_cradle_walklike_prelift_target017_drive023_retry12b \
