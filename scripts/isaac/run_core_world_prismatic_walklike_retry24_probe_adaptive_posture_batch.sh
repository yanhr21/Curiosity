...
COMMON_ENV=(
  ...
  ENABLE_PROBE_ADAPTIVE_GAIT=1
  ENABLE_PROBE_ADAPTIVE_POSTURE=1
  PROBE_ADAPTIVE_MEDIUM_RISK_THRESHOLD=0.25
  PROBE_ADAPTIVE_HIGH_RISK_THRESHOLD=0.75
  PROBE_ADAPTIVE_MEDIUM_GAIT_DRIVE_SCALE=0.98
  PROBE_ADAPTIVE_HIGH_GAIT_DRIVE_SCALE=0.92
  PROBE_ADAPTIVE_MEDIUM_POSTURE_LEG_TARGET_OFFSET=0.012
  PROBE_ADAPTIVE_HIGH_POSTURE_LEG_TARGET_OFFSET=0.024
  STEPS=2880
  PAYLOAD_MASS=10.0
...
env "${COMMON_ENV[@]}" \
  STAMP=20260706_prismatic_cradle_probe_adaptive_posture_standard10_mid_retry24a \
  PAYLOAD_SIZE_Z=0.24 \
  bash scripts/isaac/run_core_world_prismatic_carrier_stand.sh

env "${COMMON_ENV[@]}" \
  STAMP=20260706_prismatic_cradle_probe_adaptive_posture_tall10_mid_retry24b \
  PAYLOAD_SIZE_Z=0.34 \
  bash scripts/isaac/run_core_world_prismatic_carrier_stand.sh
