...
if [[ "$(hostname)" == mgmtserver* ]]; then
  echo "Refusing to run G1 held-out geometry terminal-support suite on login/management node: $(hostname)" >&2
  exit 2
fi

ROOT_DIR="${ROOT_DIR:-/public/home/yanhongru/Curiosity}"
SUITE_STAMP_PREFIX="${SUITE_STAMP_PREFIX:-20260707_g1_closefront_heldout_geometry_terminal_support}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${ROOT_DIR}/experiments/outputs/core_world_g1_closefront_heldout_geometry_terminal_support/${SUITE_STAMP_PREFIX}}"

mkdir -p "${OUTPUT_ROOT}"
status_file="${OUTPUT_ROOT}/closefront_heldout_geometry_terminal_support_status.tsv"
summary_out="${OUTPUT_ROOT}/closefront_heldout_geometry_terminal_support_summary.json"
...
run_case() {
  ...
  echo "[G1-HELDOUT-GEOMETRY-TERMINAL-SUPPORT] case=${case_name} suite_stamp=${suite_stamp}"
  ...
  env \
    ...
    AGILE_COMMAND_HOLD_TERMINAL_SCALE=0.02 \
    ...
    AGILE_COMMAND_TERMINAL_SUPPORT_START_BOX_TARGET_TRAVEL=1.35 \
    AGILE_COMMAND_TERMINAL_SUPPORT_TARGET=2.0 \
    AGILE_COMMAND_TERMINAL_SUPPORT_DEADBAND=0.06 \
    AGILE_COMMAND_TERMINAL_SUPPORT_GAIN=0.055 \
    AGILE_COMMAND_TERMINAL_SUPPORT_MAX_FORWARD=0.035 \
    AGILE_COMMAND_TERMINAL_SUPPORT_MAX_REVERSE=0.018 \
    ...
    AGILE_COMMAND_TERMINAL_SUPPORT_YAW_GAIN=0.015 \
    AGILE_COMMAND_TERMINAL_SUPPORT_YAW_LIMIT=0.015 \
    AGILE_COMMAND_TERMINAL_SUPPORT_YAW_SIGN=1.0 \
    AGILE_COMMAND_TERMINAL_SUPPORT_MAX_TILT=0.60 \
    AGILE_COMMAND_TERMINAL_SUPPORT_MAX_BOX_TILT=0.70 \
    TERMINAL_SUPPORT_POSTURE_CONTROLLER=1 \
    TERMINAL_SUPPORT_POSTURE_PROGRESS_START=1.35 \
    TERMINAL_SUPPORT_POSTURE_PROGRESS_FULL=1.95 \
    TERMINAL_SUPPORT_POSTURE_BLEND_RATE=0.015 \
    TERMINAL_SUPPORT_POSTURE_REL_START=0.14 \
    TERMINAL_SUPPORT_POSTURE_REL_STOP=0.30 \
    TERMINAL_SUPPORT_POSTURE_TILT_START=0.16 \
    TERMINAL_SUPPORT_POSTURE_TILT_STOP=0.45 \
    TERMINAL_SUPPORT_POSTURE_HIP_PITCH_OFFSET=-0.015 \
    TERMINAL_SUPPORT_POSTURE_KNEE_OFFSET=0.035 \
    TERMINAL_SUPPORT_POSTURE_ANKLE_PITCH_OFFSET=-0.020 \
    TERMINAL_SUPPORT_POSTURE_WAIST_PITCH_OFFSET=-0.010 \
    TERMINAL_SUPPORT_POSTURE_SHOULDER_PITCH_OFFSET=-0.050 \
    TERMINAL_SUPPORT_POSTURE_ELBOW_OFFSET=0.080 \
    TERMINAL_SUPPORT_POSTURE_WRIST_PITCH_OFFSET=-0.020 \
...
run_case wide_y012_terminal_support \
...
run_case tall_z009_terminal_support \
