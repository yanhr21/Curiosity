...
STAMP=20260705_direct_physical_backend_alternating_anchor_feet_probe_randomized_8cm_seed7052 \
...
python3 scripts/isaac/check_direct_carry_task_summary.py \
  experiments/outputs/direct_carry_task_physical_backend/20260705_direct_physical_backend_alternating_anchor_feet_probe_randomized_8cm_seed7052/direct_carry_task_physical_backend_summary.json \
  --min-steps 840 \
  ...
  --max-final-box-target-distance-x 0.045 \
  --max-fall-events 0 \
