...
STAMP=20260705_direct_physical_backend_alternating_anchor_feet_faststart_8cm_8kg_frontmid \
...
RAIL_LOWER=-0.04 \
RAIL_UPPER=0.10 \
SUPPORT_FOOT_MASS=12.0 \
SUPPORT_FOOT_X_LOWER=-0.16 \
SUPPORT_FOOT_X_UPPER=0.16 \
SUPPORT_FOOT_Z_LOWER=-0.005 \
SUPPORT_FOOT_Z_UPPER=0.18 \
SUPPORT_FOOT_STEP_HEIGHT=0.090 \
SUPPORT_FOOT_STANCE_X=-0.120 \
SUPPORT_FOOT_SWING_X=0.120 \
SUPPORT_FOOT_DRIVE_STIFFNESS=22000.0 \
SUPPORT_FOOT_DRIVE_DAMPING=3200.0 \
SUPPORT_FOOT_DRIVE_MAX_FORCE=100000.0 \
SUPPORT_FOOT_Z_DRIVE_STIFFNESS=26000.0 \
SUPPORT_FOOT_Z_DRIVE_DAMPING=2600.0 \
SUPPORT_FOOT_Z_DRIVE_MAX_FORCE=100000.0 \
...
python3 scripts/isaac/check_direct_carry_task_summary.py \
  experiments/outputs/direct_carry_task_physical_backend/20260705_direct_physical_backend_alternating_anchor_feet_faststart_8cm_8kg_frontmid/direct_carry_task_physical_backend_summary.json \
  --min-steps 600 \
  ...
  --min-support-foot-x-joint-motion 0.12 \
  --min-support-foot-z-joint-motion 0.04 \
