...
STAMP=20260705_direct_physical_backend_alternating_anchor_feet_belief_probe_randomized_8cm_seed7053 \
...
BOX_SEED=7053 \
RANDOMIZE_PAYLOAD=1 \
PAYLOAD_MASS_MIN=6.0 \
PAYLOAD_MASS_MAX=10.0 \
PAYLOAD_SIZE_JITTER=0.08 \
PAYLOAD_COM_OFFSET_RANGE_X=0.030 \
PAYLOAD_COM_OFFSET_RANGE_Y=0.015 \
PAYLOAD_COM_OFFSET_RANGE_Z=0.010 \
PROBE_STEPS=60 \
...
python3 scripts/isaac/check_direct_carry_task_summary.py \
  experiments/outputs/direct_carry_task_physical_backend/20260705_direct_physical_backend_alternating_anchor_feet_belief_probe_randomized_8cm_seed7053/direct_carry_task_physical_backend_summary.json \
  --min-steps 840 \
  ...
  --max-final-box-target-distance-x 0.050 \
  --max-fall-events 0 \
