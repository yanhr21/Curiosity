...
echo "[CONFIG] STAMP=${STAMP} low-CG cage stance_translate STEPS=${STEPS:-700} TARGET_X=${TARGET_X:-0.015} SETTLE_STEPS=${SETTLE_STEPS:-350} RAMP_STEPS=${RAMP_STEPS:-300}"
