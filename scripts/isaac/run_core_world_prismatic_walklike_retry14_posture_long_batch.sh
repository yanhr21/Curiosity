...
env "${COMMON_ENV[@]}" \
  STAMP=20260705_prismatic_cradle_walklike_close_x045_z016_long_retry14a \
  PAYLOAD_LOCAL_X=0.45 \
  PAYLOAD_LOCAL_Z=0.16 \
  bash scripts/isaac/run_core_world_prismatic_carrier_stand.sh

env "${COMMON_ENV[@]}" \
  STAMP=20260705_prismatic_cradle_walklike_mid_x050_z016_long_retry14b \
  PAYLOAD_LOCAL_X=0.50 \
  PAYLOAD_LOCAL_Z=0.16 \
  bash scripts/isaac/run_core_world_prismatic_carrier_stand.sh

env "${COMMON_ENV[@]}" \
  STAMP=20260705_prismatic_cradle_walklike_close_low_x045_z014_retry14c \
  PAYLOAD_LOCAL_X=0.45 \
