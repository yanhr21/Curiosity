...
base_python=(
  ...
  --agile-command-stop-tilt-threshold "${AGILE_COMMAND_STOP_TILT_THRESHOLD:-999.0}"
  --agile-command-stop-box-tilt-threshold "${AGILE_COMMAND_STOP_BOX_TILT_THRESHOLD:-999.0}"
  --agile-command-stop-tilt-min-step "${AGILE_COMMAND_STOP_TILT_MIN_STEP:--1}"
  --agile-command-stop-tilt-min-box-target-travel "${AGILE_COMMAND_STOP_TILT_MIN_BOX_TARGET_TRAVEL:--1.0}"
  ...
  --agile-command-hold-terminal-brake-command-x "${AGILE_COMMAND_HOLD_TERMINAL_BRAKE_COMMAND_X:-0.0}"
  --agile-command-hold-terminal-brake-delay-steps "${AGILE_COMMAND_HOLD_TERMINAL_BRAKE_DELAY_STEPS:-0}"
  --agile-command-hold-terminal-brake-steps "${AGILE_COMMAND_HOLD_TERMINAL_BRAKE_STEPS:-0}"
