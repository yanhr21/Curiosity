...
if [[ "$(hostname)" == mgmtserver* ]]; then
  echo "Refusing to run G1 held-out geometry terminal-support late-posture suite on login/management node: $(hostname)" >&2
  exit 2
fi

ROOT_DIR="${ROOT_DIR:-/public/home/yanhongru/Curiosity}"
SUITE_STAMP_PREFIX="${SUITE_STAMP_PREFIX:-20260707_g1_closefront_heldout_geometry_terminal_support_lateposture}"
OUTPUT_ROOT="${OUTPUT_ROOT:-${ROOT_DIR}/experiments/outputs/core_world_g1_closefront_heldout_geometry_terminal_support_lateposture/${SUITE_STAMP_PREFIX}}"

mkdir -p "${OUTPUT_ROOT}"
status_file="${OUTPUT_ROOT}/closefront_heldout_geometry_terminal_support_lateposture_status.tsv"
summary_out="${OUTPUT_ROOT}/closefront_heldout_geometry_terminal_support_lateposture_summary.json"
...
run_case() {
  ...
  echo "[G1-HELDOUT-GEOMETRY-TERMINAL-SUPPORT-LATEPOSTURE] case=${case_name} suite_stamp=${suite_stamp}"
  ...
  env \
    ...
    AGILE_COMMAND_TERMINAL_SUPPORT_GAIN=0.040 \
    ...
    TERMINAL_SUPPORT_POSTURE_PROGRESS_START=1.65 \
    TERMINAL_SUPPORT_POSTURE_PROGRESS_FULL=2.05 \
    TERMINAL_SUPPORT_POSTURE_BLEND_RATE=0.008 \
    ...
    TERMINAL_SUPPORT_POSTURE_HIP_PITCH_OFFSET=-0.010 \
    TERMINAL_SUPPORT_POSTURE_KNEE_OFFSET=0.020 \
    TERMINAL_SUPPORT_POSTURE_ANKLE_PITCH_OFFSET=-0.012 \
    TERMINAL_SUPPORT_POSTURE_WAIST_PITCH_OFFSET=-0.006 \
    TERMINAL_SUPPORT_POSTURE_SHOULDER_PITCH_OFFSET=-0.035 \
    TERMINAL_SUPPORT_POSTURE_ELBOW_OFFSET=0.050 \
    TERMINAL_SUPPORT_POSTURE_WRIST_PITCH_OFFSET=-0.014 \
...
run_case wide_y012_lateposture \
...
run_case tall_z009_lateposture \
