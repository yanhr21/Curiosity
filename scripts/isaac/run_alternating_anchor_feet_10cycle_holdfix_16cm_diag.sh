...
STAMP=20260705_direct_physical_backend_alternating_anchor_feet_10cycle_holdfix_16cm_8kg_frontmid \
...
SUPPORT_FOOT_CONTACT_Z_THRESHOLD=0.028 \
...
python3 scripts/isaac/check_direct_carry_task_summary.py \
  experiments/outputs/direct_carry_task_physical_backend/20260705_direct_physical_backend_alternating_anchor_feet_10cycle_holdfix_16cm_8kg_frontmid/direct_carry_task_physical_backend_summary.json \
  --min-steps 1160 \
  ...
  --min-box-travel 0.13 \
  --max-final-box-target-distance-x 0.04 \
  --max-fall-events 0 \
