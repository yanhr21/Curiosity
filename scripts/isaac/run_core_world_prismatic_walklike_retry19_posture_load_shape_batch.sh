...
env "${COMMON_ENV[@]}" \
  STAMP=20260705_prismatic_cradle_walklike_posture_load_mid_x050_z016_mass12_retry19a \
  PAYLOAD_MASS=12.0 \
...
env "${COMMON_ENV[@]}" \
  STAMP=20260705_prismatic_cradle_walklike_posture_load_high_x050_z018_mass12_retry19b \
  PAYLOAD_MASS=12.0 \
  PAYLOAD_LOCAL_X=0.50 \
...
env "${COMMON_ENV[@]}" \
  STAMP=20260705_prismatic_cradle_walklike_posture_shape_mid_x050_z016_tall_retry19c \
  PAYLOAD_MASS=8.0 \
  PAYLOAD_LOCAL_X=0.50 \
  PAYLOAD_LOCAL_Z=0.16 \
  PAYLOAD_SIZE_Z=0.34 \
...
env "${COMMON_ENV[@]}" \
  STAMP=20260705_prismatic_cradle_walklike_posture_shape_high_x050_z018_tall_retry19d \
  PAYLOAD_MASS=8.0 \
  PAYLOAD_LOCAL_X=0.50 \
  PAYLOAD_LOCAL_Z=0.18 \
  PAYLOAD_SIZE_Z=0.34 \
