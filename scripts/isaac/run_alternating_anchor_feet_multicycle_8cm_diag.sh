...
STAMP=20260705_direct_physical_backend_alternating_anchor_feet_multicycle_8cm_8kg_frontmid \
...
python3 scripts/isaac/check_direct_carry_task_summary.py \
  experiments/outputs/direct_carry_task_physical_backend/20260705_direct_physical_backend_alternating_anchor_feet_multicycle_8cm_8kg_frontmid/direct_carry_task_physical_backend_summary.json \
  --min-steps 700 \
  ...
  --min-box-travel 0.065 \
  --max-final-box-target-distance-x 0.025 \
  --max-fall-events 0 \
