...
run_case 20260705_direct_physical_backend_alternating_anchor_feet_probe_belief_tracking_8cm_6kg 6.0
run_case 20260705_direct_physical_backend_alternating_anchor_feet_probe_belief_tracking_8cm_10kg 10.0
...
cases = [
    "20260705_direct_physical_backend_alternating_anchor_feet_probe_belief_tracking_8cm_6kg",
    "20260705_direct_physical_backend_alternating_anchor_feet_probe_belief_tracking_8cm_10kg",
]
rows = []
for case in cases:
    ...
    rows.append({
        ...
        "probe_support_foot_x_tracking_proxy": data.get("probe_support_foot_x_tracking_proxy"),
        "probe_risk_score": data.get("probe_risk_score"),
        "probe_load_risk_bucket": data.get("probe_load_risk_bucket"),
        "max_probe_support_foot_x_tracking_error_m": data.get("max_probe_support_foot_x_tracking_error_m"),
        "mean_probe_support_foot_x_tracking_error_m": data.get("mean_probe_support_foot_x_tracking_error_m"),
...
out_dir = root / "20260705_direct_physical_backend_alternating_anchor_feet_probe_belief_tracking_calibration_8cm"
out_dir.mkdir(parents=True, exist_ok=True)
(out_dir / "tracking_calibration_summary.json").write_text(json.dumps(rows, indent=2, sort_keys=True) + "\n")
