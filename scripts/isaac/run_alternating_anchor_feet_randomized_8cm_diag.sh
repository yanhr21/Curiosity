...
STAMP=20260705_direct_physical_backend_alternating_anchor_feet_randomized_8cm_seed7051 \
...
python3 scripts/isaac/check_direct_carry_task_summary.py \
  experiments/outputs/direct_carry_task_physical_backend/20260705_direct_physical_backend_alternating_anchor_feet_randomized_8cm_seed7051/direct_carry_task_physical_backend_summary.json \
  --min-steps 760 \
  ...
  --max-final-box-target-distance-x 0.040 \
  --max-fall-events 0 \
