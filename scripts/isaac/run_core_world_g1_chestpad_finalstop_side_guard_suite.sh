...
run_case() {
  ...
  env \
    ...
    AGILE_COMMAND_HOLD_FINAL_BOX_TARGET_TRAVEL="${AGILE_COMMAND_HOLD_FINAL_BOX_TARGET_TRAVEL:-1.65}" \
    ...
    CRADLE_FINAL_SIDE_GUARD_LOCAL_Y="${CRADLE_FINAL_SIDE_GUARD_LOCAL_Y:-0.0}" \
    CRADLE_FINAL_SIDE_GUARD_LOCAL_Z="${CRADLE_FINAL_SIDE_GUARD_LOCAL_Z:-0.10}" \
    CRADLE_FINAL_SIDE_GUARD_SIZE_X="${CRADLE_FINAL_SIDE_GUARD_SIZE_X:-0.18}" \
    CRADLE_FINAL_SIDE_GUARD_SIZE_Y="${CRADLE_FINAL_SIDE_GUARD_SIZE_Y:-0.018}" \
    CRADLE_FINAL_SIDE_GUARD_SIZE_Z="${CRADLE_FINAL_SIDE_GUARD_SIZE_Z:-0.18}" \
    CRADLE_FINAL_SIDE_GUARD_HALF_SPACING="${half_spacing}" \
    CRADLE_FINAL_SIDE_GUARD_MASS_SCALE="${CRADLE_FINAL_SIDE_GUARD_MASS_SCALE:-1.0}" \
    CRADLE_FINAL_SIDE_GUARD_STATIC_FRICTION="${CRADLE_FINAL_SIDE_GUARD_STATIC_FRICTION:--1.0}" \
    CRADLE_FINAL_SIDE_GUARD_DYNAMIC_FRICTION="${CRADLE_FINAL_SIDE_GUARD_DYNAMIC_FRICTION:--1.0}" \
    CRADLE_FINAL_SIDE_GUARD_RESTITUTION="${CRADLE_FINAL_SIDE_GUARD_RESTITUTION:-0.0}" \
