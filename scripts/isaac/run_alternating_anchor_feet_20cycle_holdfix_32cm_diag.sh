...
STAMP=20260705_direct_physical_backend_alternating_anchor_feet_20cycle_holdfix_32cm_8kg_frontmid \
...
python3 scripts/isaac/check_direct_carry_task_summary.py \
  experiments/outputs/direct_carry_task_physical_backend/20260705_direct_physical_backend_alternating_anchor_feet_20cycle_holdfix_32cm_8kg_frontmid/direct_carry_task_physical_backend_summary.json \
  --min-steps 1960 \
