...
run_case 20260705_direct_physical_backend_alternating_anchor_feet_probe_belief_effort_8cm_6kg 6.0
run_case 20260705_direct_physical_backend_alternating_anchor_feet_probe_belief_effort_8cm_10kg 10.0
...
cases = [
    "20260705_direct_physical_backend_alternating_anchor_feet_probe_belief_effort_8cm_6kg",
    "20260705_direct_physical_backend_alternating_anchor_feet_probe_belief_effort_8cm_10kg",
]
rows = []
for case in cases:
    ...
    rows.append({
        ...
        "max_probe_support_foot_x_measured_effort": data.get("max_probe_support_foot_x_measured_effort"),
        "mean_probe_support_foot_x_measured_effort": data.get("mean_probe_support_foot_x_measured_effort"),
        "probe_support_foot_x_effort_proxy": data.get("probe_support_foot_x_effort_proxy"),
...
out_dir = root / "20260705_direct_physical_backend_alternating_anchor_feet_probe_belief_effort_calibration_8cm"
out_dir.mkdir(parents=True, exist_ok=True)
(out_dir / "effort_calibration_summary.json").write_text(json.dumps(rows, indent=2, sort_keys=True) + "\n")
