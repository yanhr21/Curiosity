...
env "${COMMON_ENV[@]}" \
  STAMP=20260706_prismatic_cradle_selector_heldout_standard10_mid_selected_retry21a \
...
env "${COMMON_ENV[@]}" \
  STAMP=20260706_prismatic_cradle_selector_heldout_standard10_high_control_retry21b \
  PAYLOAD_LOCAL_X=0.50 \
...
env "${COMMON_ENV[@]}" \
  STAMP=20260706_prismatic_cradle_selector_heldout_tall10_mid_selected_retry21c \
  PAYLOAD_LOCAL_X=0.50 \
  PAYLOAD_LOCAL_Z=0.16 \
  PAYLOAD_SIZE_Z=0.34 \
  bash scripts/isaac/run_core_world_prismatic_carrier_stand.sh
...
env "${COMMON_ENV[@]}" \
  STAMP=20260706_prismatic_cradle_selector_heldout_tall10_high_control_retry21d \
  PAYLOAD_LOCAL_X=0.50 \
  PAYLOAD_LOCAL_Z=0.18 \
  PAYLOAD_SIZE_Z=0.34 \
  bash scripts/isaac/run_core_world_prismatic_carrier_stand.sh
