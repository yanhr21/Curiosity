...
stamps=(
  20260705_prismatic_cradle_walklike_directional_guard_high_mid_x050_z018_retry18a
  20260705_prismatic_cradle_walklike_directional_guard_high_close_x045_z018_overdrive16_retry18b
)
