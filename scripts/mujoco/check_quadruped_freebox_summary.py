...
def main() -> int:
    ...
    if args.min_support_attitude_recovery_active_steps is not None and int(summary.get("support_attitude_recovery_active_steps", 0)) < args.min_support_attitude_recovery_active_steps:
        failures.append(
