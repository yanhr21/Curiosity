...
SUITE_SUFFIX="${SUITE_SUFFIX:-stance_force_holdcreep_negfx}"
...
run_case() {
  ...
  echo "[CASE] ${stamp} hold_speed=${hold_speed} hold_fx=${hold_fx_scale} hold_max_fx=${hold_max_fx_scale} host=$(hostname)"
  STAMP="${stamp}" \
  STEPS=3000 \
  BOX_MASS=2.0 \
  TARGET_SPEED=0.16 \
...
run_case negfx_v001_fx005 0.01 -0.05 0.30
run_case negfx_v002_fx005 0.02 -0.05 0.30
run_case negfx_v003_fx005 0.03 -0.05 0.30
run_case negfx_v001_fx010 0.01 -0.10 0.30
run_case negfx_v002_fx010 0.02 -0.10 0.30
run_case negfx_v003_fx010 0.03 -0.10 0.30
run_case negfx_v002_fx020 0.02 -0.20 0.30
run_case negfx_v002_fx030 0.02 -0.30 0.30

echo "[DONE] MuJoCo free-box stance-force hold creep negative-fx suite suffix=${SUITE_SUFFIX}"
