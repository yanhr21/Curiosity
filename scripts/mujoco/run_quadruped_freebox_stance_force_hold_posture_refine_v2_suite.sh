...
SUITE_SUFFIX="${SUITE_SUFFIX:-stance_force_holdposture_refine_v2}"
...
run_case() {
  ...
  echo "[CASE] ${stamp} hip_fb=${hold_hip_feedback} foot_roll_z=${hold_foot_roll_z} hip_base=${hold_hip_base} stance_z=${hold_stance_z} feet=${front_x}/${rear_x} host=$(hostname)"
  STAMP="${stamp}" \
  STEPS=3000 \
  BOX_MASS=2.0 \
  TARGET_SPEED=0.16 \
...
run_case refine2_hip_neg030 -0.30 -0.04 0.08 0.46 0.22 -0.22
run_case refine2_hip_neg040 -0.40 -0.04 0.08 0.46 0.22 -0.22
run_case refine2_hip_neg050 -0.50 -0.04 0.08 0.46 0.22 -0.22
run_case refine2_hip_neg060 -0.60 -0.04 0.08 0.46 0.22 -0.22
run_case refine2_combo_neg045 -0.45 -0.08 0.08 0.46 0.22 -0.22
run_case refine2_combo_neg055 -0.55 -0.08 0.08 0.46 0.22 -0.22
run_case refine2_base10_neg045 -0.45 -0.04 0.10 0.46 0.22 -0.22
run_case refine2_stance044_neg045 -0.45 -0.04 0.08 0.44 0.22 -0.22
run_case refine2_feet_wide_neg045 -0.45 -0.04 0.08 0.46 0.24 -0.24
run_case refine2_feet_mid_neg045 -0.45 -0.04 0.08 0.46 0.20 -0.20

echo "[DONE] MuJoCo free-box stance-force hold posture refine v2 suite suffix=${SUITE_SUFFIX}"
