...
SUPPORT_ATTITUDE_RECOVERY="${SUPPORT_ATTITUDE_RECOVERY:-0}"
SUPPORT_ATTITUDE_RECOVERY_START_TILT="${SUPPORT_ATTITUDE_RECOVERY_START_TILT:-0.34}"
SUPPORT_ATTITUDE_RECOVERY_FULL_TILT="${SUPPORT_ATTITUDE_RECOVERY_FULL_TILT:-0.62}"
SUPPORT_ATTITUDE_RECOVERY_ROLL_KP_DELTA="${SUPPORT_ATTITUDE_RECOVERY_ROLL_KP_DELTA:-0.0}"
SUPPORT_ATTITUDE_RECOVERY_ROLL_KD_DELTA="${SUPPORT_ATTITUDE_RECOVERY_ROLL_KD_DELTA:-0.0}"
SUPPORT_ATTITUDE_RECOVERY_PITCH_KP_DELTA="${SUPPORT_ATTITUDE_RECOVERY_PITCH_KP_DELTA:-0.0}"
SUPPORT_ATTITUDE_RECOVERY_PITCH_KD_DELTA="${SUPPORT_ATTITUDE_RECOVERY_PITCH_KD_DELTA:-0.0}"
SUPPORT_ATTITUDE_RECOVERY_HIP_ROLL_DELTA="${SUPPORT_ATTITUDE_RECOVERY_HIP_ROLL_DELTA:-0.0}"
SUPPORT_ATTITUDE_RECOVERY_FOOT_ROLL_Z_DELTA="${SUPPORT_ATTITUDE_RECOVERY_FOOT_ROLL_Z_DELTA:-0.0}"
SUPPORT_ATTITUDE_RECOVERY_HEIGHT_OFFSET="${SUPPORT_ATTITUDE_RECOVERY_HEIGHT_OFFSET:-0.0}"
SUPPORT_QP_ITERATIONS="${SUPPORT_QP_ITERATIONS:-24}"
SUPPORT_QP_REGULARIZATION="${SUPPORT_QP_REGULARIZATION:-0.001}"
SUPPORT_QP_FRICTION_MU="${SUPPORT_QP_FRICTION_MU:-0.9}"
...
if [[ "${SUPPORT_ATTITUDE_RECOVERY}" == "1" ]]; then
  EXTRA_ARGS+=(--support-attitude-recovery)
fi
...
"${ISAAC_VENV}/bin/python" \
  ...
  --support-attitude-recovery-start-tilt "${SUPPORT_ATTITUDE_RECOVERY_START_TILT}" \
  --support-attitude-recovery-full-tilt "${SUPPORT_ATTITUDE_RECOVERY_FULL_TILT}" \
  --support-attitude-recovery-roll-kp-delta "${SUPPORT_ATTITUDE_RECOVERY_ROLL_KP_DELTA}" \
  --support-attitude-recovery-roll-kd-delta "${SUPPORT_ATTITUDE_RECOVERY_ROLL_KD_DELTA}" \
  --support-attitude-recovery-pitch-kp-delta "${SUPPORT_ATTITUDE_RECOVERY_PITCH_KP_DELTA}" \
  --support-attitude-recovery-pitch-kd-delta "${SUPPORT_ATTITUDE_RECOVERY_PITCH_KD_DELTA}" \
  --support-attitude-recovery-hip-roll-delta "${SUPPORT_ATTITUDE_RECOVERY_HIP_ROLL_DELTA}" \
  --support-attitude-recovery-foot-roll-z-delta "${SUPPORT_ATTITUDE_RECOVERY_FOOT_ROLL_Z_DELTA}" \
  --support-attitude-recovery-height-offset "${SUPPORT_ATTITUDE_RECOVERY_HEIGHT_OFFSET}" \
  --support-qp-iterations "${SUPPORT_QP_ITERATIONS}" \
  --support-qp-regularization "${SUPPORT_QP_REGULARIZATION}" \
