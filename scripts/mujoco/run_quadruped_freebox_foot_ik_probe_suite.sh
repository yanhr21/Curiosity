...
SUITE_SUFFIX="${SUITE_SUFFIX:-foot_ik_probe}"
...
run_case slow_short 0.9 0.08 0.76 0.43 0.34
run_case nominal 1.1 0.12 0.72 0.43 0.32
run_case faster_long 1.4 0.16 0.68 0.43 0.31
run_case high_clearance 1.1 0.12 0.72 0.42 0.28

echo "[DONE] MuJoCo free-box foot-IK support probe suffix=${SUITE_SUFFIX}"
