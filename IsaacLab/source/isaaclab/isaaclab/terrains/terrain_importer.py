...
class TerrainImporter:
    ...
    def import_ground_plane(self, name: str, size: tuple[float, float] = (2.0e6, 2.0e6)):
        ...
        local_ground_plane_usd = os.environ.get("ISAACLAB_GROUND_PLANE_USD")
        if local_ground_plane_usd:
            ground_plane_cfg.usd_path = local_ground_plane_usd
            ground_plane_cfg.color = None
