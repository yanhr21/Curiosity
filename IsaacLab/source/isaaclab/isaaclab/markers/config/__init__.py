...
_USE_LOCAL_FRAME_MARKER = os.environ.get("ISAACLAB_USE_LOCAL_FRAME_MARKER", "0") == "1"
...
FRAME_MARKER_CFG = VisualizationMarkersCfg(
    markers={
        "frame": (
            sim_utils.SphereCfg(
                radius=0.04,
                visual_material=sim_utils.PreviewSurfaceCfg(diffuse_color=(0.0, 0.6, 1.0), roughness=0.5),
            )
            if _USE_LOCAL_FRAME_MARKER
