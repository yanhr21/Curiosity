...
from sugar_rl.assets.objects.objects import BIGBOX_CFG
import torch
...
class RobotSceneCfg(BaseRobotSceneCfg):
    obj: RigidObjectCfg = BIGBOX_CFG.replace(prim_path="{ENV_REGEX_NS}/Obj")
...
class RewardsCfg(BaseRewardsCfg):
    ...
    avoid_feet_obj_contact = RewTerm(
        func=mdp.avoid_feet_obj_contact,
        weight=1.0,
        params={
